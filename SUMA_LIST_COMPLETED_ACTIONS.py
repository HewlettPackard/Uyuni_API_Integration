...
def connect_suma(mgr_login = '', mgr_pass = ''):
    ...
    return client, key
def list_completed_actions(client, key):
    try:
        res = client.schedule.listCompletedActions(key)
        if res is None:
...
def main():
    try:
        ...
        response = list_completed_actions(client, key)
        print("\nList of actions are: ")
        print("***************************************************************************************************************************")
